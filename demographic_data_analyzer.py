...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = higher_education_rich = round((df[higher_education]['salary'] == '>50K').mean() * 100, 1)
    lower_education_rich = lower_education_rich = round((df[~higher_education]['salary'] == '>50K').mean() * 100, 1)
